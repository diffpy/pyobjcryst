...
class TestRefinableObjClock(unittest.TestCase):
    ...
    def testRelations(self):
        ...
        Calling Click on the parent or child will restore the proper
...
class TestRefinablePar(unittest.TestCase):
    ...
    def testToFromPython(self):
        """See if refinable parameters can be created from within python
        and within c++."""
    ...
    def testGetType(self):
        """See if we can get the proper RefParType from a
        RefinablePar."""
